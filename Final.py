...
# Set up environment
corpus_root = 'corpus_root = r"C:\Users\chira\Downloads\P1\P1\US_Inaugural_Addresses"'  # Path to the directory with text files
...
# Query the system
result = query("british are invading america")
